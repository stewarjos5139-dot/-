...
Linkbook lnitList_head(Linkbook L, int n);                 // 前插 n 个结点
Linkbook lnitList_end(Linkbook L, int n);                 // 后插 n 个结点
...
// 后插 n 个节点
Linkbook lnitList_end(Linkbook L, int n) {
    Linkbook p = L;
...
// 前插 n 个节点
Linkbook lnitList_head(Linkbook L, int n) {
    for (int i = 0; i < n; i++) {
